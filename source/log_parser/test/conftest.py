...
CLOUDFRONT_LOG_FILE_LOCAL_PATH = (
    "./test/test_data/E3HXCM7PFRG6HT.2023-04-24-21.d740d76bCloudFront.gz"
)
...
CLOUDFRONT_LOG_FILE_S3_KEY = (
    "AWSLogs/E3HXCM7PFRG6HT.2023-04-24-21.d740d76bCloudFront.gz"
)
...
def s3_resources_setup(s3_client):
    ...
    conn.upload_file(
        ATHENA_QUERY_RESULT_FILE_LOCAL_PATH,
        S3_BUCKET_NAME,
        ATHENA_QUERY_RESULT_FILE_S3_KEY,
    )
    conn.upload_file(
        CLOUDFRONT_LOG_FILE_LOCAL_PATH, S3_BUCKET_NAME, CLOUDFRONT_LOG_FILE_S3_KEY
    )
    ...
    conn.upload_file(
        APP_LOG_CONF_FILE_LOCAL_PATH, S3_BUCKET_NAME, APP_LOG_CONF_FILE_S3_KEY
    )
    conn.upload_file(
        APP_LOG_OUTPUT_FILE_LOCAL_PATH, S3_BUCKET_NAME, APP_LOG_OUTPUT_FILE_S3_KEY
    )
    conn.upload_file(
        WAF_LOG_CONF_FILE_LOCAL_PATH, S3_BUCKET_NAME, WAF_LOG_CONF_FILE_S3_KEY
    )
    conn.upload_file(
        WAF_LOG_OUTPUT_FILE_LOCAL_PATH, S3_BUCKET_NAME, WAF_LOG_OUTPUT_FILE_S3_KEY
    )
...
def glue_resources_setup(glue_client):
    ...
    conn.create_table(
        DatabaseName=GLUE_DATABASE_NAME, TableInput={"Name": GLUE_TABLE_NAME}
    )
        ...
        "Records": [
            {
                "s3": {
                    ...
                    "object": {"key": ATHENA_QUERY_RESULT_FILE_S3_KEY},
                }
            }
        ]
    }
        ...
        "Records": [
            {
                "s3": {
                    "bucket": {"name": S3_BUCKET_NAME},
                    "object": {"key": CLOUDFRONT_LOG_FILE_S3_KEY},
                }
            }
        ]
    }
        ...
        "Records": [
            {
                "s3": {
                    "bucket": {"name": S3_BUCKET_NAME},
                    "object": {"key": ALB_LOG_FILE_S3_KEY},
                }
            }
        ]
    }
        ...
        "Records": [
            {
                "s3": {
                    "bucket": {"name": S3_BUCKET_NAME},
                    "object": {"key": WAF_LOG_FILE_S3_KEY},
                }
            }
        ]
    }
